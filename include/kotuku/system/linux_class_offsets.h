...
inline constexpr int32_t CLASS_OFFSET_NETSERVER = 344;
// Network module end
...
inline constexpr int32_t CLASS_OFFSET_VECTORELLIPSE = 984;
...
inline constexpr int32_t CLASS_OFFSET_VECTORSHAPE = 984;
inline constexpr int32_t CLASS_OFFSET_VECTORSPIRAL = 984;
inline constexpr int32_t CLASS_OFFSET_VECTORVIEWPORT = 984;
inline constexpr int32_t CLASS_OFFSET_VECTORWAVE = 984;
