...
FDEF argsAsyncCancel[] = { { "Error", FD_INT|FD_ERROR }, { "Objects", FDF_VECTOR|FD_OBJECTID }, { 0, 0 } };
...
FDEF argsCreateFolder[] = { { "Error", FD_INT|FD_ERROR }, { "Path", FDF_CPPSTRING }, { "Permissions", FD_INT }, { 0, 0 } };
FDEF argsCreateLink[] = { { "Error", FD_INT|FD_ERROR }, { "From", FDF_CPPSTRING }, { "To", FDF_CPPSTRING }, { 0, 0 } };
FDEF argsCurrentContext[] = { { "Object", FD_OBJECTPTR }, { 0, 0 } };
FDEF argsCurrentTask[] = { { "Object", FD_OBJECTPTR }, { 0, 0 } };
FDEF argsDeleteFile[] = { { "Error", FD_INT|FD_ERROR }, { "Path", FDF_CPPSTRING }, { "Callback", FD_FUNCTIONPTR }, { 0, 0 } };
FDEF argsDeleteVolume[] = { { "Error", FD_INT|FD_ERROR }, { "Name", FDF_CPPSTRING }, { 0, 0 } };
...
FDEF argsGetEventID[] = { { "Result", FD_INT64 }, { "Group", FD_INT }, { "SubGroup", FDF_CPPSTRING }, { "Event", FDF_CPPSTRING }, { 0, 0 } };
...
FDEF argsReadFileToBuffer[] = { { "Error", FD_INT|FD_ERROR }, { "Path", FDF_CPPSTRING }, { "Buffer", FDF_SPAN|FD_MUTABLE|FD_BYTE }, { "Result", FD_RESULT|FD_INT }, { 0, 0 } };
...
FDEF argsScanMessages[] = { { "Error", FD_INT|FD_ERROR }, { "Handle", FD_RESULT|FD_INT }, { "Type", FD_INT }, { "Buffer", FDF_SPAN|FD_MUTABLE|FD_BYTE }, { 0, 0 } };
FDEF argsSendMessage[] = { { "Error", FD_INT|FD_ERROR }, { "Type", FD_INT }, { "Flags", FD_INT }, { "Data", FDF_SPAN|FD_BYTE }, { 0, 0 } };
