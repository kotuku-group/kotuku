...
FDEF argsAllocMemory[] = { { "Error", FD_INT|FD_ERROR }, { "Size", FD_INT }, { "Flags", FD_INT }, { "Address", FD_RESULT|FD_PTR }, { "ID", FD_RESULT|FD_INT }, { 0, 0 } };
FDEF argsAllocateID[] = { { "Result", FD_INT }, { "Type", FD_INT }, { 0, 0 } };
FDEF argsAnalysePath[] = { { "Error", FD_INT|FD_ERROR }, { "Path", FD_CPP|FD_STR }, { "Type", FD_RESULT|FD_INT }, { 0, 0 } };
FDEF argsAsyncAction[] = { { "Error", FD_INT|FD_ERROR }, { "Action", FD_INT }, { "Object", FD_OBJECTPTR }, { "Args", FD_PTR }, { "Callback", FD_FUNCTIONPTR }, { 0, 0 } };
FDEF argsAsyncCancel[] = { { "Error", FD_INT|FD_ERROR }, { "Objects", FD_CPP|FD_ARRAY|FD_OBJECTID }, { 0, 0 } };
FDEF argsAsyncPending[] = { { "Result", FD_INT }, { "Object", FD_OBJECTID }, { 0, 0 } };
FDEF argsAsyncWait[] = { { "Error", FD_INT|FD_ERROR }, { "Objects", FD_CPP|FD_ARRAY|FD_OBJECTID }, { "TimeOut", FD_INT }, { 0, 0 } };
...
FDEF argsClassDatabase[] = { { "Error", FD_INT|FD_ERROR }, { "ClassRecord:Classes", FD_RESULT|FD_CPP|FD_ARRAY|FD_MUTABLE|FD_PTR|FD_STRUCT }, { 0, 0 } };
...
FDEF argsFindObject[] = { { "Error", FD_INT|FD_ERROR }, { "Name", FD_CPP|FD_STR }, { "ClassID", FD_INT|FD_UNSIGNED }, { "ObjectID", FD_RESULT|FD_OBJECTID }, { 0, 0 } };
...
FDEF argsIdentifyFile[] = { { "Error", FD_INT|FD_ERROR }, { "Path", FD_CPP|FD_STR }, { "Filter", FD_INT|FD_UNSIGNED }, { "Class", FD_RESULT|FD_INT|FD_UNSIGNED }, { "SubClass", FD_RESULT|FD_INT|FD_UNSIGNED }, { 0, 0 } };
...
FDEF argsLoadFile[] = { { "Error", FD_INT|FD_ERROR }, { "Path", FD_CPP|FD_STR }, { "Flags", FD_INT }, { "CacheFile:Cache", FD_RESULT|FD_PTR|FD_STRUCT|FD_RESOURCE }, { 0, 0 } };
...
FDEF argsOpenDir[] = { { "Error", FD_INT|FD_ERROR }, { "Path", FD_CPP|FD_STR }, { "Flags", FD_INT }, { "DirInfo:Info", FD_RESULT|FD_PTR|FD_STRUCT|FD_RESOURCE|FD_ALLOC }, { 0, 0 } };
...
FDEF argsReadFileToBuffer[] = { { "Error", FD_INT|FD_ERROR }, { "Path", FD_CPP|FD_STR }, { "Buffer", FD_BUFFER|FD_MUTABLE|FD_PTR }, { "BufferSize", FD_INT|FD_BUFSIZE }, { "Result", FD_RESULT|FD_INT }, { 0, 0 } };
FDEF argsReadInfoTag[] = { { "Error", FD_INT|FD_ERROR }, { "FileInfo:Info", FD_PTR|FD_STRUCT }, { "Name", FD_CPP|FD_STR }, { "Value", FD_RESULT|FD_CPP|FD_STR }, { 0, 0 } };
FDEF argsReallocMemory[] = { { "Error", FD_INT|FD_ERROR }, { "Memory", FD_PTR }, { "Size", FD_INT|FD_UNSIGNED }, { "Address", FD_RESULT|FD_PTR|FD_ALLOC }, { "ID", FD_RESULT|FD_INT }, { 0, 0 } };
...
FDEF argsResolvePath[] = { { "Error", FD_INT|FD_ERROR }, { "Path", FD_CPP|FD_STR }, { "Flags", FD_INT }, { "Result", FD_RESULT|FD_MUTABLE|FD_CPP|FD_STR }, { 0, 0 } };
