...
FDEF argsRead[]          = {
   { "Buffer", FDF_SPAN|FD_MUTABLE|FD_PTR, &glSpanFieldOps<int8_t> }, { "Result", FD_INT|FD_RESULT }, { 0, 0 }
};
...
FDEF argsWrite[]         = {
   { "Buffer", FDF_SPAN|FD_PTR, &glSpanFieldOps<const int8_t> }, { "Result", FD_INT|FD_RESULT }, { 0, 0 }
};
