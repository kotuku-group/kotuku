...
FDEF maCompressBuffer[] = { { "Input", FDF_SPAN|FD_PTR }, { "Output", FDF_SPAN|FD_MUTABLE|FD_PTR }, { "Result", FD_RESULT|FD_INT }, { 0, 0 } };
FDEF maCompressFile[] = { { "Location", FDF_CPPSTRING }, { "Path", FDF_CPPSTRING }, { 0, 0 } };
FDEF maDecompressBuffer[] = { { "Input", FDF_SPAN|FD_PTR }, { "Output", FDF_SPAN|FD_MUTABLE|FD_PTR }, { "Result", FD_RESULT|FD_INT }, { 0, 0 } };
FDEF maDecompressFile[] = { { "Path", FDF_CPPSTRING }, { "Dest", FDF_CPPSTRING }, { "Flags", FD_INT }, { 0, 0 } };
FDEF maRemoveFile[] = { { "Path", FDF_CPPSTRING }, { 0, 0 } };
FDEF maCompressStream[] = { { "Input", FDF_SPAN|FD_PTR }, { "Callback", FD_FUNCTION }, { "Output", FDF_SPAN|FD_MUTABLE|FD_PTR }, { 0, 0 } };
FDEF maDecompressStream[] = { { "Input", FDF_SPAN|FD_PTR }, { "Callback", FD_FUNCTION }, { "Output", FDF_SPAN|FD_MUTABLE|FD_PTR }, { 0, 0 } };
FDEF maCompressStreamEnd[] = { { "Callback", FD_FUNCTION }, { "Output", FDF_SPAN|FD_MUTABLE|FD_PTR }, { 0, 0 } };
