...
extern "C" void lj_env_check(lua_State *, GCtab *, GCstr *, TValue *);
extern "C" void lj_env_check_override(lua_State *, GCtab *, GCstr *, TValue *, GCstr *);
extern "C" void lj_env_store(lua_State *, GCtab *, GCstr *, TValue *);
