...
static const FieldArray clGradientVoronoiFields[] = {
   { "Floor",         FDF_VIRTUAL|FDF_UNIT|FDF_SCALED|FDF_RW|FDF_PURE, GRADIENTVORONOI_GET_Floor, GRADIENTVORONOI_SET_Floor },
   { "Multiplier",    FDF_VIRTUAL|FDF_UNIT|FDF_SCALED|FDF_RW|FDF_PURE, GRADIENTVORONOI_GET_Multiplier, GRADIENTVORONOI_SET_Multiplier },
