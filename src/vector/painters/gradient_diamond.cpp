...
static const FieldArray clGradientDiamondFields[] = {
   { "CX",      FDF_VIRTUAL|FDF_UNIT|FDF_SCALED|FDF_RW|FDF_PURE, GRADIENTDIAMOND_GET_CX, GRADIENTDIAMOND_SET_CX },
   { "CY",      FDF_VIRTUAL|FDF_UNIT|FDF_SCALED|FDF_RW|FDF_PURE, GRADIENTDIAMOND_GET_CY, GRADIENTDIAMOND_SET_CY },
   { "Radius",  FDF_VIRTUAL|FDF_UNIT|FDF_SCALED|FDF_RW|FDF_PURE, GRADIENTDIAMOND_GET_Radius, GRADIENTDIAMOND_SET_Radius },
   END_FIELD
};
