...
static const FieldArray clGradientLinearFields[] = {
   { "X1", FDF_VIRTUAL|FDF_UNIT|FDF_SCALED|FDF_RW|FDF_PURE, GRADIENTLINEAR_GET_X1, GRADIENTLINEAR_SET_X1 },
   { "Y1", FDF_VIRTUAL|FDF_UNIT|FDF_SCALED|FDF_RW|FDF_PURE, GRADIENTLINEAR_GET_Y1, GRADIENTLINEAR_SET_Y1 },
   { "X2", FDF_VIRTUAL|FDF_UNIT|FDF_SCALED|FDF_RW|FDF_PURE, GRADIENTLINEAR_GET_X2, GRADIENTLINEAR_SET_X2 },
   { "Y2", FDF_VIRTUAL|FDF_UNIT|FDF_SCALED|FDF_RW|FDF_PURE, GRADIENTLINEAR_GET_Y2, GRADIENTLINEAR_SET_Y2 },
   END_FIELD
};
