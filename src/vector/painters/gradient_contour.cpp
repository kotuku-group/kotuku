...
static const FieldArray clGradientContourFields[] = {
   { "Floor", FDF_VIRTUAL|FDF_UNIT|FDF_DOUBLE|FDF_SCALED|FDF_RW|FDF_PURE, GRADIENTCONTOUR_GET_Floor, GRADIENTCONTOUR_SET_Floor },
   { "Multiplier", FDF_VIRTUAL|FDF_UNIT|FDF_DOUBLE|FDF_SCALED|FDF_RW|FDF_PURE, GRADIENTCONTOUR_GET_Multiplier, GRADIENTCONTOUR_SET_Multiplier },
   END_FIELD
};
