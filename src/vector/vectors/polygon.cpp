...
static const FieldArray clPolygonFields[] = {
   ...
   { "X1",          FDF_VIRTUAL|FDF_UNIT|FDF_RW|FDF_PURE, POLY_GET_X1, POLY_SET_X1 },
   { "Y1",          FDF_VIRTUAL|FDF_UNIT|FDF_RW|FDF_PURE, POLY_GET_Y1, POLY_SET_Y1 },
   { "X2",          FDF_VIRTUAL|FDF_UNIT|FDF_RW|FDF_PURE, POLY_GET_X2, POLY_SET_X2 },
   { "Y2",          FDF_VIRTUAL|FDF_UNIT|FDF_RW|FDF_PURE, POLY_GET_Y2, POLY_SET_Y2 },
   END_FIELD
};
