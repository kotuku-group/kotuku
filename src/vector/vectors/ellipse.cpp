...
static const FieldArray clEllipseFields[] = {
   { "Width",      FDF_VIRTUAL|FDF_UNIT|FDF_SCALED|FDF_RW|FDF_PURE, VECTORELLIPSE_GET_Width,   VECTORELLIPSE_SET_Width },
   { "Height",     FDF_VIRTUAL|FDF_UNIT|FDF_SCALED|FDF_RW|FDF_PURE, VECTORELLIPSE_GET_Height,  VECTORELLIPSE_SET_Height },
   { "CX",         FDF_VIRTUAL|FDF_UNIT|FDF_SCALED|FDF_RW|FDF_PURE, VECTORELLIPSE_GET_CX, VECTORELLIPSE_SET_CX },
   { "CY",         FDF_VIRTUAL|FDF_UNIT|FDF_SCALED|FDF_RW|FDF_PURE, VECTORELLIPSE_GET_CY, VECTORELLIPSE_SET_CY },
   { "Radius",     FDF_VIRTUAL|FDF_UNIT|FDF_SCALED|FDF_RW|FDF_PURE, VECTORELLIPSE_GET_Radius,  VECTORELLIPSE_SET_Radius },
   { "RadiusX",    FDF_VIRTUAL|FDF_UNIT|FDF_SCALED|FDF_RW|FDF_PURE, VECTORELLIPSE_GET_RadiusX, VECTORELLIPSE_SET_RadiusX },
   { "RadiusY",    FDF_VIRTUAL|FDF_UNIT|FDF_SCALED|FDF_RW|FDF_PURE, VECTORELLIPSE_GET_RadiusY, VECTORELLIPSE_SET_RadiusY },
   { "Vertices",   FDF_VIRTUAL|FDF_INT|FDF_RW|FDF_PURE, VECTORELLIPSE_GET_Vertices, VECTORELLIPSE_SET_Vertices },
   // Synonyms
   { "R",  FDF_SYNONYM|FDF_VIRTUAL|FDF_UNIT|FDF_SCALED|FDF_RW|FDF_PURE, VECTORELLIPSE_GET_Radius,  VECTORELLIPSE_SET_Radius },
   { "RX", FDF_SYNONYM|FDF_VIRTUAL|FDF_UNIT|FDF_SCALED|FDF_RW|FDF_PURE, VECTORELLIPSE_GET_RadiusX, VECTORELLIPSE_SET_RadiusX },
   { "RY", FDF_SYNONYM|FDF_VIRTUAL|FDF_UNIT|FDF_SCALED|FDF_RW|FDF_PURE, VECTORELLIPSE_GET_RadiusY, VECTORELLIPSE_SET_RadiusY },
   END_FIELD
};
