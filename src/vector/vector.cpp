...
OBJECTPTR clGradientDiffusion = nullptr, clGradientDistal = nullptr, clGradientVoronoi = nullptr;
...
static ERR MODExpunge(void)
{
   ...
   if (clGradientDiffusion) { FreeResource(clGradientDiffusion); clGradientDiffusion = nullptr; }
