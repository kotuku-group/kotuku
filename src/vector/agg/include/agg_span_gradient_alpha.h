...
// ---
// Modulates generated spans with an alpha gradient. Hooks into span_gradient, gradient functions, and renderer_scanline
// span pipelines. In the vector renderer it varies opacity independently from colour across gradient-filled geometry.
...
public:
    ...
    span_gradient_alpha(interpolator_type &inter, const GradientF &gradient_function,
       const AlphaF& alpha_function, double d1, double d2) :
