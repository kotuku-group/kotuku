...
// ---
// Generates grayscale Gouraud-shaded spans for triangles. Hooks into span_gouraud interpolation and grayscale
// renderer_scanline paths. In the vector renderer it produces per-pixel intensity gradients for shaded mesh-style
// primitives.
//
