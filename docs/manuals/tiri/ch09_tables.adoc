// VERIFIED: 2026-02-11
// CHANGED: 2026-07-30 — Documented zero-based sequence boundaries and unspecified lengths for tables with gaps.
// CHANGED: 2026-07-30 — Documented the nil/NaN key restriction and float-to-integer key normalisation.
...
// UPDATED: 2026-07-26 - Range indices must be whole-numbered; fractional ranges raise an error (commit 687f1eb7)
