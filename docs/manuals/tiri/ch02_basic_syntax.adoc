// VERIFIED: 2026-02-10
// CHANGED: 2026-07-30 — Corrected the claim that semicolons carry no semantic weight; added sec-statement-ambiguity.
// UPDATED: 2026-07-30 — Documented binary integer literals.
// UPDATED: 2026-07-06 -- Added `extern` to the keyword list.
...
Statements are separated by line breaks or semicolons.  Semicolons are optional except where a statement boundary is otherwise ambiguous; see <<sec-statement-ambiguity>>.
...
Tiri is a free-form language.  Line breaks have no syntactic significance; statements are not terminated by newlines.  See <<sec-statement-ambiguity>> for the one case in which a statement boundary requires an explicit semicolon.
