...
//                       (commit 5c92d652a)
// UPDATED: 2026-08-19 - Removed `metamethod` from the keyword table; it is now an ordinary identifier (commit 81aa5f3)
...
|`local`    |`namespace`|`nil`    |`not`      |`or`      |`raise`
|`repeat`   |`return`  |`success` |`then`     |`thunk`   |`true`
|`try`      |`until`   |`using`   |`when`     |`while`   |`with`
|===
