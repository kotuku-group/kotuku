// CHANGED: 2026-07-07 - Documented comma-separated import lists and their restrictions (#1618).
// CHANGED: 2026-08-07 - An imported file is its own compilation unit for module namespaces (commit 45b671b20).
// CHANGED: 2026-06-28 - Documented parent-relative ('../') import resolution.
// VERIFIED: 2026-02-13
// CHANGED: 2026-07-31 — Aligned the chapter title with the manual's organisation terminology.
// UPDATED: 2026-08-11 - Migrated a string method call to dot syntax (commit 7e6746950)
...
The following restrictions apply to import lists:

. Every list item must be a string literal.  A non-string entry or a trailing comma raises a parse error.
. The `as` clause is not permitted in a list.
